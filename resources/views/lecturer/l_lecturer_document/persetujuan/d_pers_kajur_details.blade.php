        ...
        <section class="bg-white dark:bg-gray-900">
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg border border-slate-800">
                    ...
                    @endif
                            ...
                            <tbody>
                                @forelse ($attendencedetail as $d)
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                        ...
                                        <td class="px-6 py-4 text-center align-middle">{{\Carbon\Carbon::parse($d->created_at)->translatedFormat('j F Y') }}</td>
                        ...
                        <div class="mt-4 text-left">
                            <button type="submit" onclick="openModalVerifikasi({{ $data->id }})"
                                class="bg-green-600 hover:bg-green-700 text-white font-semibold m-3 px-6 py-2 rounded-lg">
                                Setujui Dokumen
                            </button>
                        </div>
                        @endif
            ...
            <div id="verifikasi-modal"
                ...
                <div class="bg-white rounded-lg shadow-lg p-6 w-1/3">
                    <h2 class="text-lg font-semibold mb-4">Konfirmasi Persetujuan</h2>
                    <p class="mb-4">Apakah Anda yakin ingin setujui data ini?</p>
                    <div class="flex justify-end">
                        ...
                        <button id="confirm-button" class="bg-green-600 text-white px-4 py-2 rounded-md"
                            onclick="confirmVerifikasi()">Setujui</button>
                    </div>
                </div>
            </div>
