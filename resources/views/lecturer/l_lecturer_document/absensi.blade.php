            ...
            <div class="py-4 px-2 mx-auto lg:m-8 sm:m-4">
                ...
                @else
                    ...
                    <a href="{{ route('lecturer.lecturer_document.edit_student', $ad->id) }}"
                            class="inline-flex items-center justify-center w-20 text-center font-medium bg-yellow-400 text-white px-3 py-2 rounded-md hover:bg-yellow-500 transition duration-300 mt-3">
