        ...
        <div class="py-4 px-2 mx-auto lg:m-8 sm:m-4">
            ...
            <form action="{{ route('masterdata.lecturer_documents.update', $lecturer_document->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    <div class="w-full">
                        <label for="code_al" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kode Daftar Hadir</label>
                        <input type="text" name="code_al" id="code_al" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="{{ old('code_al', $lecturer_document->code_al) }}" required>
                    </div>
                    <div class="w-full">
