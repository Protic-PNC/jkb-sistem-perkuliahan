        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="py-4 px-2 mx-auto lg:m-8 sm:m-4">
                ...
                <div class="mb-3 flex items-center justify-between">
                    <a href="{{ route('masterdata.study_programs.create') }}" class="inline-block">
                        <button type="button"
                    ...
                    <form action="{{ route('masterdata.study_programs.index') }}" method="GET" class="flex items-center">
                        <div class="relative">
                        ...
                        <tbody>
                            @forelse ($data as $a)
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="px-3 py-2 text-slate-800">{{ $a->jenjang }}</td>

                                    <td class="px-3 py-2 flex space-x-2 justify-center ">
                                        <a href="{{ route('masterdata.study_programs.edit', $a->id) }}"
                                        ...
                                        <form action="{{ route('masterdata.study_programs.destroy', $a->id) }}"
