    ...
    @section('content')
        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="py-4 px-2 mx-auto lg:m-8 sm:m-4">
                <div>
                    <h3 class="text-lg font-semibold text-gray-700 dark:text-gray-200 mb-4">Mata Kuliah</h3>
                ...
                <div class="mb-3 flex items-center justify-between">
                    <a href="{{ route('masterdata.courses.create') }}" class="inline-block">
                        <button type="button"
                    ...
                    <form action="{{ route('masterdata.courses.index') }}" method="GET" class="flex items-center">
                        <div class="relative">
                        ...
                        <tbody>
                            @forelse ($data as $a)
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="px-3 py-2 text-slate-800">{{ $a->type }}</td>
                                    <td class="px-3 py-2 text-slate-800">{{ $a->sks }}</td>
                                    <td class="px-3 py-2 text-slate-800">{{ $a->hours }}</td>
                                    <td class="px-3 py-2 text-slate-800">{{ $a->meeting }}</td>
                                    <td class="px-3 py-2 flex space-x-2 justify-center ">
                                        <a href="{{ route('masterdata.courses.edit', $a->id) }}"
