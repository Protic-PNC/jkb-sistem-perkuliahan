...
<div class="container px-6 py-8 mx-auto">
    ...
    <div class="bg-white dark:bg-gray-900 rounded-sm">
        <div class="py-4 px-2 mx-auto lg:m-8 sm:m-4">
            <div class="text-2xl font-semibold text-gray-600"> Halo, {{ Auth::user()->name }}!</div>
        </div>
    </div>
    @role('super_admin')
 <div class="mt-4">
